...
<div id="no">
	...
	<div id="inno">
		...
		<a href="iplfacregform.php"><button style="background-color: rgba(0,0,0,0.0); color:white; font-size: 70%; border-radius: 10px; margin-right: 10px;" onmouseover="blue(this)" onmouseout="non(this)" >SIGN UP</button></a>
	</div>

</div>
<div id="logform">
  
  <form method="POST" action="iplfaclog.php">
    
		    <b style="background-color:;">FACULTY ID</b><br>
			<input type="text" id="yes" required name="fid" style="border-radius:10px; color:white; background-color: rgba(0,0,0,0); width:50%; line-height:3;">
		     <br><br>
