...
<script type="text/javascript">
	...
	function form_valid()
	{
        ...
        var susn=document.getElementById("userusn").value;
        ...
        if(sname=="" || susn=="" || sbranch=="" || semail=="" || sphone=="" || spassword=="" || spassword2=="")
        {
...
<div id="no">
    ...
    <div id="inno">
        ...
        <a href="iplstulogform.php"><button style="background-color: rgba(0,0,0,0.0); color:white; font-size: 70%; border-radius: 10px; margin-right: 10px;" onmouseover="blue(this)" onmouseout="non(this)" >LOGIN</button></a>
    </div>
...
<div id="main">
<form method ="POST" action ="iplregstn.php" onsubmit="return form_valid();">
<div id="field">
...
<b1 style="font-size: 20px;">USN:</b1> <br><input type ="text" name = "usn" id="userusn" style=" border-radius:10px; color:white; background-color: rgba(0,0,0,0); width:50%; line-height:2; " required><b>*</b>
</br><br>
<b1 style="font-size: 20px;">BRANCH:</b1> <br><select  name = "branch" id="userbranch" style=" border-radius:10px; color:white; background-color: rgba(0,0,0,0); font-size: 20px;  width:50%; line-height:3;" required><b>*</b>
<option value="cs1" style="border-radius:10px; width:100%; line-height:2; color:black; ">CSE</option>
<option value="is1" style="border-radius:10px; width:100%; line-height:2; color: black; ">ISE</option>
<option value="ec1" style="border-radius:10px; width:100%; line-height:2; color:black;">ECE</option>
<option value="ee1" style="border-radius:10px; width:100%; line-height:2; color:black; ">EEE</option>
<option value="me1" style="border-radius:10px; width:100%; line-height:2; color: black;">ME</option>
</select><b>*</b>
<br><br>
